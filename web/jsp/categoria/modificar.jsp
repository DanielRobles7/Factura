<%-- 
    Document   : modificar
    Created on : 26-oct-2018, 22:32:25
    Author     : DanyDanny
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Modificar Categoria</h1>
                    <html:form>
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <div>
                                        ...
                                        <html:text property="idCategoria" styleClass="form-control" style="width: 100px; border-color: gray"  readonly="true"></html:text>
                                            <br>
                                        </div>
                                        <div>
                                            <label style="font-weight: bold;">Nombre : </label>
                                        <html:text property="nombre" styleClass="form-control" style="width: 400px; border-color: gray"  ></html:text>
                                            <br>
                                        </div>
                                        <div>
                                            <label style="font-weight: bold; align-items: center">Descripción : </label>
                                        <html:textarea property="descripcion" styleClass="form-control" style="border-color: gray "></html:textarea>
                                            <br>
                                        </div>
