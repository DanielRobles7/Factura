...
<html>
    ...
    <body style="background: #ABABAB; min-height: 700px">
        ...
        <div class="container">
            <div class="row" >
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Lista de Categorias</h1>
                    <table class="table table-hover table-dark">
                        ...
                        <tbody>
                            <logic:notEmpty name="CategoriaActionForm" property="listaCategoria">
                                <logic:iterate id="ver" name="CategoriaActionForm" property="listaCategoria">
                                    <tr class="table-secondary" style="color: black">
                                        <html:form action="/categoria">
                                            <td class="text-center" scope="row" style="vertical-align: middle">
                                                <bean:write name="ver" property="idCategoria" />
                                                <html:hidden name="ver" property="idCategoria"/>
                                            </td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="nombre" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="descripcion" /></td>
