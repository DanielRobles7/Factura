...
<html>
    ...
    <body style="background: #ABABAB; min-height: 700px">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Guardar Modificar</h1>
                    <html:form>
                                ...
                                <div class="form-group col-6">
                                    <div class="row">
                                        <div class="form-group col-3">
                                            ...
                                            <html:text property="idCliente" styleClass="form-control" style=" border-color: gray" readonly="true"></html:text>
                                            </div>
                                        ...
                                        <div>
                                            <label style="font-weight: bold; align-items: center">Fecha de Nacimiento : </label>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div>
                                            <label style="font-weight: bold; align-items: center">Teléfono : </label>
