...
<html>
    ...
    <body style="background: #ABABAB; min-height: 700px">
        ...
        <div class="container">
            <div class="row" >
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Lista de Clientes</h1>
                    <table class="table table-hover table-dark">
                        ...
                        <tbody>
                            <logic:notEmpty name="ClienteActionForm" property="listaCliente">
                                <logic:iterate id="ver" name="ClienteActionForm" property="listaCliente">
                                    <tr class="table-secondary text-center" style="color: black">
                                        <html:form action="/cliente">
                                            <td class="text-center" scope="row" style="vertical-align: middle">
                                                <bean:write name="ver" property="idCliente" />
                                                <html:hidden name="ver" property="idCliente"/>
                                            </td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="nombreCliente" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="apellidoCliente" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="direccionCliente" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="fechaNacimiento" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="telefono" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="email" /></td>
