...
<html>
    <head>
        ...
        <title>Guardar Nuevo Modo de Pago</title>
    ...
    <body style="background: #ABABAB; min-height: 700px">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Guardar Nuevo Modo de Pago</h1>
                    <html:form>
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    <div>
                                        ...
                                        <html:text property="idPago" styleClass="form-control" style="width: 100px; border-color: gray" readonly="true"></html:text>
                                            <br>
                                        </div>
                                        <div>
                                            <label style="font-weight: bold;">Nombre : </label>
                                        <html:text property="nombreModoPago" styleClass="form-control" style="width: 400px; border-color: gray"  ></html:text>
                                            <br>
                                        </div>
                                        <div>
                                            <label style="font-weight: bold; align-items: center">Descripción : </label>
                                        <html:textarea property="otrosDetalles" styleClass="form-control" style="border-color: gray "></html:textarea>
                                            <br>
                                        </div>
