...
<html>
    ...
    <body style="background: #ABABAB; min-height: 700px">
        ...
        <div class="container">
            <div class="row" >
                <div class="col-12">
                    <h1 class="text-center" style="padding: 10px; font-weight: bold;">Lista de Modos de Pago</h1>
                    <table class="table table-hover table-dark">
                        <thead >
                            <tr class="text-center" >
                                <th scope="col" style="vertical-align: middle">ID</th>
                                <th scope="col" style="vertical-align: middle">Nombre</th>
                                <th scope="col" style="vertical-align: middle">Otros Detalles</th>
                                <th scope="col" style="vertical-align: middle"></th>
                                <th scope="col" style="vertical-align: middle">
                                    <html:form action="/modoPago">
                        ...
                        <tbody>
                            <logic:notEmpty name="ModoPagoActionForm" property="listaModoPago">
                                <logic:iterate id="ver" name="ModoPagoActionForm" property="listaModoPago">
                                    <tr class="table-secondary" style="color: black">
                                        <html:form action="/modoPago">
                                            <td class="text-center" scope="row" style="vertical-align: middle">
                                                <bean:write name="ver" property="idPago" />
                                                <html:hidden name="ver" property="idPago"/>
                                            </td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="nombreModoPago" /></td>
                                            <td style="vertical-align: middle"><bean:write name="ver" property="otrosDetalles" /></td>
